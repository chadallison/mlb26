...
```
    ...
    ##  [2] "15-run defeat: Arizona Diamondbacks, Chicago Cubs (1)"                                       
    ##  [3] "14-run defeat: Athletics, Kansas City Royals, San Francisco Giants, Washington Nationals (1)"
    ##  [4] "13-run defeat: Los Angeles Angels, Minnesota Twins (2)"                                      
    ##  [5] "12-run defeat: New York Mets (2)"                                                            
    ##  [6] "11-run defeat: Athletics, Philadelphia Phillies (2)"                                         
    ##  [7] "10-run defeat: Baltimore Orioles, Cincinnati Reds, San Francisco Giants (2)"                 
    ##  [8] "9-run defeat: Colorado Rockies, Pittsburgh Pirates (3)"                                      
    ##  [9] "8-run defeat: Colorado Rockies, Houston Astros, Washington Nationals (4)"                    
    ## [10] "7-run defeat: Boston Red Sox (6)"                                                            
    ## [11] "6-run defeat: San Diego Padres (6)"                                                          
    ## [12] "5-run defeat: Houston Astros, San Francisco Giants, Seattle Mariners (7)"                    
    ## [13] "4-run defeat: San Francisco Giants (7)"                                                      
    ## [14] "3-run defeat: Toronto Blue Jays (10)"                                                        
    ## [15] "2-run defeat: Boston Red Sox, Kansas City Royals (12)"                                       
    ## [16] "1-run defeat: Detroit Tigers (14)"                                                           
    ## [17] "1-run victory: Philadelphia Phillies (15)"                                                   
    ## [18] "2-run victory: Baltimore Orioles (13)"                                                       
    ## [19] "3-run victory: Texas Rangers (11)"                                                           
    ## [20] "4-run victory: Arizona Diamondbacks, Atlanta Braves, Miami Marlins, Seattle Mariners (6)"    
    ## [21] "5-run victory: Chicago Cubs (8)"                                                             
    ## [22] "6-run victory: Milwaukee Brewers (7)"                                                        
    ## [23] "7-run victory: Houston Astros, New York Yankees, St. Louis Cardinals (4)"                    
    ## [24] "8-run victory: Los Angeles Angels, Seattle Mariners (4)"                                     
    ## [25] "9-run victory: Los Angeles Dodgers (4)"                                                      
    ## [26] "10-run victory: Pittsburgh Pirates, Texas Rangers (2)"                                       
    ## [27] "11-run victory: Houston Astros, Pittsburgh Pirates (2)"                                      
    ## [28] "12-run victory: Milwaukee Brewers (2)"                                                       
    ## [29] "13-run victory: Washington Nationals (2)"                                                    
    ## [30] "14-run victory: Cincinnati Reds, Colorado Rockies, Milwaukee Brewers, New York Yankees (1)"  
    ## [31] "15-run victory: Atlanta Braves, San Francisco Giants (1)"                                    
