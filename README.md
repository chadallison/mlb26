...
```
    ...
    ## [12] "5-run defeat: Cincinnati Reds, Houston Astros, New York Mets, San Francisco Giants, Washington Nationals (6)"                     
    ...
    ## [15] "2-run defeat: Boston Red Sox, Houston Astros (9)"                                                                                 
    ## [16] "1-run defeat: Detroit Tigers (13)"                                                                                                
    ## [17] "1-run victory: Philadelphia Phillies (13)"                                                                                        
    ## [18] "2-run victory: Baltimore Orioles (12)"                                                                                            
    ## [19] "3-run victory: Texas Rangers (11)"                                                                                                
    ## [20] "4-run victory: Arizona Diamondbacks, Atlanta Braves, Miami Marlins, Seattle Mariners, Tampa Bay Rays (5)"                         
    ...
    ## [23] "7-run victory: Houston Astros, New York Yankees (4)"                                                                              
    ## [24] "8-run victory: Atlanta Braves, Los Angeles Dodgers, Seattle Mariners (3)"                                                         
    ## [25] "9-run victory: Los Angeles Dodgers, New York Mets (3)"                                                                            
    ## [26] "10-run victory: Pittsburgh Pirates (2)"                                                                                           
    ## [27] "11-run victory: Pittsburgh Pirates (2)"                                                                                           
    ## [28] "12-run victory: Milwaukee Brewers (2)"                                                                                            
    ## [29] "13-run victory: Chicago White Sox, Los Angeles Dodgers, San Francisco Giants, Toronto Blue Jays, Washington Nationals (1)"        
