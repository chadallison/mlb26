...
```
    ...
    ##  [3] "14-run defeat: Kansas City Royals, San Francisco Giants, Washington Nationals (1)"                                                
    ...
    ##  [9] "8-run defeat: Colorado Rockies, Houston Astros (4)"                                                                               
    ## [10] "7-run defeat: Boston Red Sox (6)"                                                                                                 
    ## [11] "6-run defeat: San Diego Padres (6)"                                                                                               
    ## [12] "5-run defeat: Houston Astros (7)"                                                                                                 
    ## [13] "4-run defeat: Minnesota Twins, New York Mets, San Francisco Giants, St. Louis Cardinals (6)"                                      
    ## [14] "3-run defeat: Toronto Blue Jays (10)"                                                                                             
    ## [15] "2-run defeat: Boston Red Sox, Kansas City Royals (11)"                                                                            
    ## [16] "1-run defeat: Detroit Tigers, Seattle Mariners (13)"                                                                              
    ## [17] "1-run victory: Chicago White Sox, Philadelphia Phillies (14)"                                                                     
    ...
    ## [21] "5-run victory: Atlanta Braves, Chicago Cubs, Cincinnati Reds (7)"                                                                 
    ## [22] "6-run victory: Milwaukee Brewers (6)"                                                                                             
    ## [23] "7-run victory: Houston Astros, New York Yankees, St. Louis Cardinals (4)"                                                         
    ## [24] "8-run victory: Atlanta Braves, Los Angeles Angels, Los Angeles Dodgers, Seattle Mariners (3)"                                     
    ...
    ## [30] "14-run victory: Cincinnati Reds, Milwaukee Brewers, New York Yankees (1)"                                                         
