...
```
    ...
    ## [17] "1-run victory: Chicago White Sox, Philadelphia Phillies, St. Louis Cardinals (10)"                                                                                 
    ## [18] "2-run victory: Baltimore Orioles, Cleveland Guardians, St. Louis Cardinals (9)"                                                                                    
    ## [19] "3-run victory: Tampa Bay Rays, Texas Rangers (8)"                                                                                                                  
    ## [20] "4-run victory: Atlanta Braves, Tampa Bay Rays (5)"                                                                                                                 
